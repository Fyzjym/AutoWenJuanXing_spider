...
# answer
# submitdata : 1$1}2$2}3$3}4$5}5$3}6$2}7$2}8$1
# data  :
...
class WenJuanXing:
    ...
    def set_data(self):
        ...
        sumdata = '1$1}2$2}3$2}4$3}5$3}6$3}7$3}8$3}9$3}10$3}11$3}12$3}13$3}14$3}15$3}16$3}17$3}18$3}19$3}20$3}21$3}22$3}23$3}24$3}25$3}26$3}27$3}28$3}29$3'
    ...
    def set_header(self):
        ...
        ip = '{}.{}.{}.{}'.format(61, random.randint(129, 191), random.randint(1, 215), random.randint(1, 244))
        self.header = {
            #'X-Forwarded-For': ip,
...
if __name__ == '__main__':
    ...
    global wjxUrl
    wjxUrl = ''
    w = WenJuanXing(wjxUrl)
    w.mul_run(10) # row number :12
